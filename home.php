...
<h2 class="title text-center">See the services of GIA Homes:</h2>
    <div class="row align-items-center card-contain center">
        <div class="col col-12 col-sm-12 col-md-4">
            <div class="text-center" style="margin: 20px auto; height: 40vh; width: 90%">
                <div class="card shadow text-center">
                    <img class="service-icons align-items-center" src="functions/images/real-estate.png" alt="...">
                    <div class="card-body">
        ...
        <div class="col col-12 col-sm-12 col-md-4">
            <div class="text-center" style="margin: 20px auto; height: 40vh; width: 90%">
                <div class="card shadow text-center">
                <img class="service-icons align-items-center" src="functions/images/sell.png" alt="...">
                    <div class="card-body">
        ...
        <div class="col col-12 col-sm-12 col-md-4">
            <div class="text-center" style="margin: 20px auto; height: 40vh; width: 90%">
                <div class="card shadow text-center">
                <img class="service-icons align-items-center" src="functions/images/search1.png" alt="...">
                    <div class="card-body">
